 ...
 * @final
 */
proto.pingpong.PingPongServiceClient = function (hostname, credentials, options) {
  if (!options) options = {};
  options["format"] = "text";
 ...
 * @final
 */
proto.pingpong.PingPongServicePromiseClient = function (hostname, credentials, options) {
  if (!options) options = {};
  options["format"] = "text";
 ...
 */
proto.pingpong.PingPongServiceClient.prototype.pingPong = function (request, metadata, callback) {
 ...
 */
proto.pingpong.PingPongServicePromiseClient.prototype.pingPong = function (request, metadata) {
